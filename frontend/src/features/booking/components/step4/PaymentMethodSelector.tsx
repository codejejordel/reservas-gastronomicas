  ...
  return (
    <div className="flex flex-col gap-3">
      <button
        ...
        className={`flex min-h-12 items-center gap-3 w-full px-3 py-3.5 rounded-xl border-2 transition-all text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 lg:gap-4 lg:px-4 ${
          value === 'MP'
      ...
      <button
        type="button"
        disabled
        className="flex min-h-12 items-center gap-3 w-full px-3 py-3.5 rounded-xl border-2 border-outline-variant bg-surface-container-lowest opacity-50 cursor-not-allowed text-left lg:gap-4 lg:px-4"
      >
