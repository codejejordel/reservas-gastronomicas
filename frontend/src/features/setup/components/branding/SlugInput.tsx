...
export function SlugInput({ value, onChange }: SlugInputProps) {
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <div className="flex items-center border border-outline-variant rounded-lg overflow-hidden bg-white focus-within:border-primary focus-within:shadow-[0_0_0_2px_rgba(7,169,169,0.15)] transition-all">
